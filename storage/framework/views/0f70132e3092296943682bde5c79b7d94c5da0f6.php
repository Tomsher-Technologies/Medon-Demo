    ...
    <div class="modal-dialog modal-sm modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <a href="" id="delete-link" autofocus class="btn btn-primary mt-2"><?php echo e(translate('Delete')); ?></a>
            </div>
        </div>
    </div>
</div><!-- /.modal -->
<?php /**PATH C:\wamp64\www\jisha\Medon\resources\views/modals/delete_modal.blade.php ENDPATH**/ ?>