    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('offers.store')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">Name<span class="text-danger" style="font-size: 20px;line-height: 1;">*</span></label>
                            <div class="col-md-9">
                                <input type="text" placeholder="Name" value="<?php echo e(old('name')); ?>" id="name"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('slug-check', ['model' => 'App\\Models\\Offers', 'template' => 2])->html();
} elseif ($_instance->childHasBeenRendered('dGLgQba')) {
    $componentId = $_instance->getRenderedChildComponentId('dGLgQba');
    $componentTag = $_instance->getRenderedChildComponentTagName('dGLgQba');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dGLgQba');
} else {
    $response = \Livewire\Livewire::mount('slug-check', ['model' => 'App\\Models\\Offers', 'template' => 2]);
    $html = $response->html();
    $_instance->logRenderedChild('dGLgQba', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    ...
                                    <input value="<?php echo e(old('image')); ?>" type="hidden" name="image" class="selected-files"
                                        required>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    ...
                                    <div class="form-control file-amount">Choose File</div>
                                    <input value="<?php echo e(old('mobile_image')); ?>" type="hidden" name="mobile_image" class="selected-files"
                                        required>
                                </div>
                                <div class="file-preview box sm">
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select onchange="banner_form()" class="form-control aiz-selectpicker" name="link_type"
                                    ...
                                    <option <?php echo e(old('link_type') == 'product' ? 'selected' : ''); ?> value="product">Product
                                    </option>
                                    <option <?php echo e(old('link_type') == 'category' ? 'selected' : ''); ?> value="category">Category
                                    </option>
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control aiz-selectpicker" onchange="offer_form()" name="offer_type"
                                    ...
                                    <option <?php echo e(old('offer_type') == 'percentage' ? 'selected' : ''); ?> value="percentage">
                                        Percentage</option>
                                    <option <?php echo e(old('offer_type') == 'amount_off' ? 'selected' : ''); ?> value="amount_off">
                                        Amount Off</option>
                                    <option <?php echo e(old('offer_type') == 'buy_x_get_y' ? 'selected' : ''); ?>
                        ...
                        <div class="form-group row offer_type_item" style="display: none" id="percentage">
                            ...
                            <div class="col-md-9">
                                <input type="number" step=".01" placeholder="Offer Percentage"
                                    value="<?php echo e(old('percentage')); ?>" id="percentage" name="percentage" class="form-control">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row offer_type_item" style="display: none" id="amount">
                            ...
                            <div class="col-md-9">
                                <input type="number" step=".01" placeholder="Offer Amount" value="<?php echo e(old('amount')); ?>"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" min="1" step="1" placeholder="Buy Quantity"
                                        value="<?php echo e(old('buy_amount')); ?>" id="buy_amount" name="buy_amount"
                                        class="form-control">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" min="1" step="1" placeholder="Get Quantity"
                                        value="<?php echo e(old('get_amount')); ?>" id="get_amount" name="get_amount"
                                        class="form-control">
                        ...
                        <div class="form-group row d-none">
                            ...
                            <div class="col-md-9">
                                <select class="form-control aiz-selectpicker" name="status" id="status" required>
                                    <option <?php echo e(old('status') == '1' ? 'selected' : ''); ?> value="1">Enabled</option>
                                    <option <?php echo e(old('status') == '0' ? 'selected' : ''); ?> value="0">Disabled</option>
                                </select>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\jisha\Medon\resources\views/backend/offers/create.blade.php ENDPATH**/ ?>