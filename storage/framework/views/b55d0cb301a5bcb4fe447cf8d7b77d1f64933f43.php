                        ...
                        <form class="row" id="sort_brands" action="" method="GET">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control" id="status" name="status">
                                    ...
                                    <option value="1" <?php if($status == '1'): ?> selected <?php endif; ?>>Active</option>
                                    <option value="2" <?php if($status == '0'): ?> selected <?php endif; ?>>Inactive</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <button class="btn btn-warning" type="submit">Filter</button>
                                <a href="<?php echo e(route('brands.index')); ?>" class="btn btn-info">Reset</a>
                            </div>
                        </form>
                    </div>
                </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\jisha\Medon\resources\views/backend/product/brands/index.blade.php ENDPATH**/ ?>