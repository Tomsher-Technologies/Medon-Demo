                ...
                <form action="<?php echo e(route('wish_report.index')); ?>" method="GET">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 col-md-4">
                            ...
                            <a class="btn btn-info mt-4" href="<?php echo e(route('wish_report.index')); ?>" >Reset</a>
                            <a href="<?php echo e(route('export.wish_report')); ?>"  class="btn btn-danger mt-4" style="border-radius: 30px;">Excel Export</a>
                        </div>
                    </div>
                </form>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?php echo e($product->wishlists->count()); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\jisha\Medon\resources\views/backend/reports/wish_report.blade.php ENDPATH**/ ?>