                ...
                <?php if(userHasPermision(10)): ?>
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('sales_report.index')); ?>"
                                    class="aiz-side-nav-link <?php echo e(areActiveRoutes(['sales_report.index'])); ?>">
...
<?php /**PATH C:\wamp64\www\jisha\Medon\resources\views/backend/inc/admin_sidenav.blade.php ENDPATH**/ ?>