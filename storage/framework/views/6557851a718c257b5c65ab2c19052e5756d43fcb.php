            ...
            <form class="form-horizontal" action="<?php echo e(route('staffs.store')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="<?php echo e(translate('Name')); ?>" id="name" name="name" class="form-control" value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="<?php echo e(translate('Email')); ?>" id="email" name="email" class="form-control" value="<?php echo e(old('email')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text"  placeholder="971" id="phone" name="phone" class="form-control" value="<?php echo e(old('phone')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="password" placeholder="<?php echo e(translate('Password')); ?>" id="password" name="password" class="form-control" autocomplete="new-password" value="<?php echo e(old('password')); ?>">
                        ...
                        <div class="col-sm-9">
                            <select id="shop_id" name="shop_id" class="form-control aiz-selectpicker" data-live-search="true" data-max-options="10" >
                                ...
                                <?php $__currentLoopData = $shops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option <?php if($shop->id == old('shop_id')): ?> <?php echo e('selected'); ?> <?php endif; ?> value="<?php echo e($shop->id); ?>"><?php echo e($shop->name); ?></option>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\jisha\Medon\resources\views/backend/staff/staffs/create.blade.php ENDPATH**/ ?>