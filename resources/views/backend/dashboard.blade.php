...
@section('content')
    ...
    @if (Auth::user()->user_type == 'admin' || in_array('1', json_decode(Auth::user()->staff->role->permissions)))
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="row"  action="{{ route('admin.dashboard') }}" method="GET">
                    <div class="col-sm-6 col-md-4">
                        <label class="col-form-label">{{translate('Sort by Category')}} :</label>
                        <select id="demo-ease" class="from-control aiz-selectpicker" data-width="100%" data-live-search="tru" name="category_id" data-selected={{ $category_id }}>
                    ...
                    <div class="col-sm-6 col-md-4">
                        ...
                        <a class="btn btn-info mt-4" href="{{ route('admin.dashboard') }}" >Reset</a>
                        <a href="{{ route('export.top_selling_report') }}"  class="btn btn-danger mt-4" style="border-radius: 30px;">Excel Export</a>
                    </div>
                </form>
                                ...
                                <div
                                    ...
                                    <div class="position-relative">
                                        <img class="img-fit lazyload mx-auto h-210px"
                                            ...
                                            data-src="{{ get_product_image($product->thumbnail_img, '300') }}" alt="{{ $product->name }}"
