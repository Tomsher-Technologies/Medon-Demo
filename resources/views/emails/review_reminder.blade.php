                                ...
                                <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0"
                                    ...
                                    <tr style="text-align: left;">
                                        <td style="font: 16px Arial, Helvetica, sans-serif;color: #404040;padding: 0px 30px 30px;">
                                            ...
                                            <p>We hope you're enjoying your recent order! We'd be grateful if you could leave a review for the product{{ count($links) > 1 ? 's' : '' }} you purchased:</p>

                                            <ul style="padding: 1%;">
                                                @foreach ($links as $link)
                                                    <li class="product">
                                                        <a href="{{ $link['url'] }}" style="">{{ $link['name'] }}</a>
                                                    </li>
                                                @endforeach
                                            </ul>
