        ...
        if($user){
            $validator = Validator::make($request->all(), [
             ...
             if($validator->fails()){
                ...
                if ($errors->has('eid_front')) {
                    return response()->json(['status' => false, 'message' => $errors->first('eid_front') ], 200);
                }
            
                if ($errors->has('phone')) {
                    return response()->json(['status' => false, 'message' => $errors->first('phone') ], 200);
                }
    
                if ($errors->has('eid_back')) {
                    return response()->json(['status' => false, 'message' => $errors->first('eid_back')  ], 200);
                }
