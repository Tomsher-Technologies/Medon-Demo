...
Route::get('/export-top-selling-report', [AdminController::class, 'exportTopSellingReport'])->name('export.top_selling_report')->middleware(['auth', 'admin']);
...
Route::group(['prefix' => env('ADMIN_PREFIX'), 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::post('/move-order', [OrderController::class, 'move_order'])->name('move-order');
    ...
    Route::post('/uploaded-files/multi-delete', [AizUploadController::class, 'multiDelete'])->name('uploaded-files.multi-delete');
